...
public class AudioBook extends AudioContent
{
	...
	//defines audiobook variables
	private String author; 
	private String narrator;
	private ArrayList<String> chapterTitles;
	private ArrayList<String> chapters;
	//initialize the current chapter to be read to zero
	private int currentChapter = 0;

	//audiobook object constructor
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	public ArrayList<String> info()
	{
		...
		Scanner separator = new Scanner(author + " " + narrator + " " + chapterTitles + " " + chapters);
		//seperates strings/arraylists of multiple words to add one at a time into the arraylist
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	{
		//sets current chapter played to the chapter parameter after checking it exists
	...
	{
		AudioBook otherAud = (AudioBook) other;
		return super.equals(other) && author.equals(otherAud.author) && narrator.equals(otherAud.narrator);
	}
